 ...
 function loadJSON(callback) {   
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		loadJSON(function(response) {
			...
			document.getElementById("Themen").innerHTML = '<p><strong>Vortrag 1:</strong> ' + data.Thema[0] + '</p>' +
			'<p><strong>Vortrag 2:</strong> ' + data.Thema[1] + '</p>' +
			'<p><strong>Außerdem:</strong> ' + data.Thema[2] + '</p>';
