 ...
 function loadJSON(callback) {   
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		loadJSON(function(response) {
			...
			document.getElementById("Themen").innerHTML = '<p><strong>Vortrag 1:</strong> ' + data[0].Thema.Vortrag[0] + '</p>' +
			'<p><strong>Vortrag 2:</strong> ' + data[0].Thema.Vortrag[1] + '</p>' +
			'<p><strong>Außerdem:</strong> ' + data[0].Thema.Vortrag[2] + '</p>';
